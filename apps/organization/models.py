...
class CourseOrg(models.Model):
    ...
    category=models.CharField(max_length=50,verbose_name=u'机构类别',choices=(('pxjg',u'培训机构'),('gx','高校'),('gr','个人')),default='pejg')
    chilc_nums=models.IntegerField(default=0,verbose_name=u'点击数')
    fav_nums=models.IntegerField(default=0,verbose_name=u'收藏数')
    image=models.ImageField(upload_to='org/%Y/%m',verbose_name=u'封面图')
    address=models.CharField(max_length=150,verbose_name=u'机构地址')
    city=models.ForeignKey(CityDict,verbose_name=u'所在城市')
    studets=models.IntegerField(default=0,verbose_name=u'学习人数')
...
class Teacher(models.Model):
    ...
    image=models.ImageField(upload_to='teacher/%Y/%m',verbose_name=u'头像',blank=True,null=True)
    fav_nums=models.IntegerField(default=0,verbose_name=u'收藏数')
    add_time=models.DateTimeField(default=datetime.now,verbose_name=u'添加时间')
